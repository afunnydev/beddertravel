...
const Routes = () => (
  <Grid container spacing={2} direction="row" style={{ marginTop: 20 }}>
    ...
    <Grid item xs={12} md={4}>
      <BigPaper elevation={3}>
        <Link to="https://beddertravel.freshdesk.com/a/dashboard/sample" target="_blank" rel="noopener noreferer">Freshdesk</Link>
      </BigPaper>
    </Grid>
    <Grid item xs={12} md={4}>
      <BigPaper elevation={3}>
        <Link to="https://dashboard.stripe.com" target="_blank" rel="noopener noreferer">Stripe</Link>
      </BigPaper>
    </Grid>
  </Grid>
);
