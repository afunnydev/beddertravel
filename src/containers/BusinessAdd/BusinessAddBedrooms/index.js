...
import { withConnect as withReduxConnect } from '../BusinessAddBedroomsRedux';
import BusinessAddBedroomsRedux from '../BusinessAddBedroomsRedux/Loadable';

BedderValidator.prepareTextField();

/* eslint-disable react/prefer-stateless-function */
export class BusinessAddBedrooms extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.vRefs = BedderValidator.makeRefs(BedderValidator.getBusinessAddRoomPage());
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <BusinessAddBedroomsRedux modelResult={this.props.modelResult} />
