...
} from '../BusinessAddGeneralInformationRedux/actions';
import { withConnect as withReduxConnect } from '../BusinessAddGeneralInformationRedux';
import BusinessAddGeneralInformationRedux from '../BusinessAddGeneralInformationRedux/Loadable';
...
export class BusinessAddGeneralInformation extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      latitude: null,
...
BusinessAddGeneralInformation.propTypes = {
