...
export const CHANGE_PROPERTYTYPE =
  'app/BusinessEditGeneralInformationRedux/CHANGE_PROPERTYTYPE';
export const CHANGE_STARS =
  'app/BusinessEditGeneralInformationRedux/CHANGE_STARS';
...
export const CHANGE_AROUND =
  'app/BusinessEditGeneralInformationRedux/CHANGE_AROUND';
export const CHANGE_HOWTOFIND =
  'app/BusinessEditGeneralInformationRedux/CHANGE_HOWTOFIND';
