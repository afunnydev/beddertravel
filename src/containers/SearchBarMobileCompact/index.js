...
import { withConnect as withReduxProps } from './SearchBarMobileCompactRedux';
import SearchBarMobileCompactRedux from './SearchBarMobileCompactRedux/Loadable';
import { withRouter } from 'react-router-dom';
import {
  changeLatAction,
  changeLocationAction,
  changeLonAction,
} from './SearchBarMobileCompactRedux/actions';
import {
  submitAction,
...
class SearchBarMobileCompact extends React.Component {
  constructor(props) {
    ...
    // this.vRefs = BedderValidator.makeRefs(BedderValidator.getSearchBarMobileCompact());
  }
  ...
  submit() {
    ...
    // if(!BedderValidator.validate(BedderValidator.getSearchBarMobileCompact())) {
    //   return false;
    // }
  ...
  componentDidUpdate(prevProps, prevState) {
    // console.log('searchBarMobileCompact componentDidUpdate');
...
SearchBarMobileCompact.propTypes = {};
