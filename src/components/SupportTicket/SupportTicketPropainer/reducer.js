/*
 *
 * SupportTicketPropainer reducer
 *
 */
...
function supportTicketPropainerReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case CHANGE_TYPE:
      return state.set('type', action.type);
    case CHANGE_NAME:
...
export default supportTicketPropainerReducer;
